...
#module purge && module load gnutools/2.69 cmake/3.9.1 gnu/7.2.0  # (this is old version, see below) gnutools/2.69 must go before gnu/7.2.0
module purge && module load cmake/3.12.1 gnu/7.2.0                # as of Feb 2021
...
## Newer instructions about building MIXeR on TSD
