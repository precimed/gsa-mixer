...
class LdMatrixCsr {
 public:
   ...
   int num_ld_r_snp(SnpIndex snp_index);  // how many LD r entries is there for snp_index
   int num_ld_r_tag(TagIndex tag_index);  // how many LD r entries is there for tag_index
