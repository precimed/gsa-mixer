...
# py.test precimed/mixer-test/test_dev_cli.py  -k version
def test_version():
    call=f'python precimed/mixer_dev.py --version'
    out = subprocess_run(call)
    assert out.returncode == 0

# py.test precimed/mixer-test/test_dev_cli.py  -k test_ld
...
# py.test precimed/mixer-test/test_dev_cli.py  -k test_snps
def test_snps():
...
# py.test precimed/mixer-test/test_dev_cli.py  -k test_savelib_file
...
# py.test precimed/mixer-test/test_dev_cli.py  -k test_fit1
...
# py.test precimed/mixer-test/test_dev_cli.py  -k test_test1
@pytest.mark.parametrize("trait_index", [1, 2])
...
# py.test precimed/mixer-test/test_dev_cli.py  -k test_figures_fit1
...
# py.test precimed/mixer-test/test_dev_cli.py  -k test_figures_test1
@pytest.mark.parametrize("trait_index", [1, 2])
...
# py.test precimed/mixer-test/test_dev_cli.py  -k test_fit2
def test_fit2():
...
# py.test precimed/mixer-test/test_dev_cli.py  -k test_fit2_region
...
# py.test precimed/mixer-test/test_dev_cli.py  -k test_test2
def test_test2():
...
# py.test precimed/mixer-test/test_dev_cli.py  -k test_figures_fit2
...
# py.test precimed/mixer-test/test_dev_cli.py  -k test_split_sumstats
...
# py.test precimed/mixer-test/test_dev_cli.py  -k test_plsa_savelib_file
...
# py.test precimed/mixer-test/test_dev_cli.py  -k test_plsa_baseline_trait1
def test_plsa_baseline_trait1():
    run_plsa(baseline=True, trait='trait1')

# py.test precimed/mixer-test/test_dev_cli.py  -k test_plsa_baseline_trait2
def test_plsa_baseline_trait2():
    run_plsa(baseline=True, trait='trait2')

# py.test precimed/mixer-test/test_dev_cli.py  -k test_plsa_gsa_full_model_withSE
def test_plsa_gsa_full_model_withSE():
    run_plsa(baseline=False, trait='trait1')

# py.test precimed/mixer-test/test_dev_cli.py  -k test_plsa_gsa_full_model_woSE
def test_plsa_gsa_full_model_woSE():
    run_plsa(baseline=False, trait='trait1', se_samples=0)

# py.test precimed/mixer-test/test_dev_cli.py  -k test_plsa_gsa_full_model_justbase
...
# py.test precimed/mixer-test/test_dev_cli.py  -k test_plsa_model_vs_baseline_enrichment
...
# py.test precimed/mixer-test/test_dev_cli.py  -k test_plsa_model_vs_baseline_enrichment_fast_calc
def test_plsa_model_vs_baseline_enrichment_fast_calc():
    run_plsa_model_vs_baseline_enrichment(calc_loglike_diff_go_test='fast')

# py.test precimed/mixer-test/test_dev_cli.py  -k test_plsa_model_vs_baseline_enrichment_full_calc
def test_plsa_model_vs_baseline_enrichment_full_calc():
    run_plsa_model_vs_baseline_enrichment(calc_loglike_diff_go_test='full')

# py.test precimed/mixer-test/test_dev_cli.py  -k test_plsa_fit1
@pytest.mark.parametrize("trait_index", [1, 2])
...
# py.test precimed/mixer-test/test_dev_cli.py  -k test_plsa_test1
def test_plsa_test1():
...
# py.test precimed/mixer-test/test_dev_cli.py  -k test_figures_plsa_fit1
...
# py.test precimed/mixer-test/test_dev_cli.py  -k test_figures_plsa_test1
...
# py.test precimed/mixer-test/test_dev_cli.py  -k test_plsa_fit2
def test_plsa_fit2():
...
# py.test precimed/mixer-test/test_dev_cli.py  -k test_plsa_test2
def test_plsa_test2():
...
# py.test precimed/mixer-test/test_dev_cli.py  -k test_figures_plsa_fit2
...
# py.test precimed/mixer-test/test_dev_cli.py  -k test_plsa_fit1_infinitesimal
@pytest.mark.parametrize("trait_index", [1,2])
...
# py.test precimed/mixer-test/test_dev_cli.py  -k test_plsa_fit2_infinitesimal
...
# py.test precimed/mixer-test/test_dev_cli.py  -k test_save_matlab_reference
